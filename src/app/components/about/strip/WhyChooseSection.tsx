        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {c.reasons.map((reason, i) => (
            ...
            >
              ...
              <div
                className={cn(
                  "absolute -top-3 -right-3 text-8xl font-black opacity-[0.06] select-none pointer-events-none transition-opacity group-hover:opacity-[0.1]",
              ...
              <span
                className={cn(
                  "inline-block text-xs font-black px-2.5 py-1 rounded-md mb-4 tracking-wider",
                  reason.accent === "primary"
                    ? "bg-[var(--primary)]/10 text-[var(--primary)]"
                    : "bg-[var(--secondary)]/10 text-[var(--secondary-foreground)]"
                )}
              >
                {reason.num}
              </span>
              ...
              <h3
                className={cn(
                  "font-bold text-[var(--foreground)] text-base md:text-lg mb-2",
